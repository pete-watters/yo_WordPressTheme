...
(function(global, factory) {
    ...
    var NO_TRANSITION =         'pp-notransition';
    ...
    var AUTO_HEIGHT =       'pp-auto-height';
    var AUTO_HEIGHT_SEL =   '.pp-auto-height';
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function addVerticalNavigation(){
            $body.append('<div id="pp-nav"><a class="bc_button action_goToApp">Get Instant Quotes</a><ul></ul></div>');
        ...
        */
        function afterSectionLoads (v){
            ...
            v.element.find('.pp-scrollable').mouseover();
