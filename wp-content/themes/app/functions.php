...
require_once 'inc/Custom_Widget.sample.php';
...
class HyperionTheme extends Hyperion{
	...
	*/
	...
	function remove_footer_admin () {
		echo get_avatar('' , '40' );
		echo 'Theme designed and developed by <a href="" target="_blank"></a> and powered by <a href="http://wordpress.org" target="_blank">WordPress</a>. Version @@version';
	}
