<?php
/**
 * test template for displaying the standard Loop
 *
 * @package WordPress
 * @subpackage test
 * @since test 1.0
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-content"><?php
		...
		<?php else : ?>
			...
			<?php the_content( __( 'Continue reading &raquo', 'test' ) ); ?>
		...
		<?php
			wp_link_pages(
				array(
					'before'           => '<div class="linked-page-nav"><p>'. __( 'This article has more parts: ', 'test' ),
					'after'            => '</p></div>',
